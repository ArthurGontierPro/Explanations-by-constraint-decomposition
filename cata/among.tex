...
%% X_{i} \neq t : 1 candidate(s) -> 0 rule(s); dropped F 0, cycle 0, duplicate 0, undefined index set 1
%%   ** REFUSED for X_{i} \neq t: 1 branch(es) reference undefined index set(s) D4; emitting them would state a rule over a set the artifact never defines (W1-T2) **
